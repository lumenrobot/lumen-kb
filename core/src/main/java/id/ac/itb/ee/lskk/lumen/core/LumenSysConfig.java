 ...
 * <ul>
 *   <li>{@link id.ac.itb.ee.lskk.lumen.core.LumenSysConfig#getTenantEnv <em>Tenant Env</em>}</li>
 * </ul>
 * </p>
 *
 * @see id.ac.itb.ee.lskk.lumen.core.LumenPackage#getLumenSysConfig()
 * @model
 * @generated
 */
public interface LumenSysConfig extends GeneralSysConfig, MongoSysConfig, FacebookSysConfig, InstagramSysConfig, YouTubeSysConfig, PinterestSysConfig, TwitterSysConfig {
	 ...
	 * @see id.ac.itb.ee.lskk.lumen.core.LumenPackage#getLumenSysConfig_TenantEnv()
	 * @model
	 * @generated
	 */
	String getTenantEnv();
	...
	/**
	 * Sets the value of the '{@link id.ac.itb.ee.lskk.lumen.core.LumenSysConfig#getTenantEnv <em>Tenant Env</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
