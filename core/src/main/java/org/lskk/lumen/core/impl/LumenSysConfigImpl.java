 ...
 * <ul>
 *   <li>{@link LumenSysConfigImpl#getMongoUri <em>Mongo Uri</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookAppId <em>Facebook App Id</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookAppSecret <em>Facebook App Secret</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookTenantAccessToken <em>Facebook Tenant Access Token</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookProfileId <em>Facebook Profile Id</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookProfileUsername <em>Facebook Profile Username</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookProfileName <em>Facebook Profile Name</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookTenantPageId <em>Facebook Tenant Page Id</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookTenantPageUsername <em>Facebook Tenant Page Username</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookTenantPublishEnabled <em>Facebook Tenant Publish Enabled</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookExplicitlyShared <em>Facebook Explicitly Shared</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookPixelId <em>Facebook Pixel Id</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getFacebookPixelEnabled <em>Facebook Pixel Enabled</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getInstagramScreenName <em>Instagram Screen Name</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getYouTubeTenantScreenName <em>You Tube Tenant Screen Name</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getPinterestTenantScreenName <em>Pinterest Tenant Screen Name</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getTwitterConsumerKey <em>Twitter Consumer Key</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getTwitterConsumerSecret <em>Twitter Consumer Secret</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getTwitterTenantScreenName <em>Twitter Tenant Screen Name</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getTwitterTenantAccessToken <em>Twitter Tenant Access Token</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getTwitterTenantAccessTokenSecret <em>Twitter Tenant Access Token Secret</em>}</li>
 *   <li>{@link LumenSysConfigImpl#getTenantEnv <em>Tenant Env</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
